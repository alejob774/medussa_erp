...
# Variable de contexto global para el aislamiento de datos (Tenant)
...
def set_company_context(empresa_id: str) -> None:
    """Establece el ID de la empresa en el contexto para la solicitud actual."""
