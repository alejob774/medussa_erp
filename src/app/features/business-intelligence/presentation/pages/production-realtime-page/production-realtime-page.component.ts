    ...
    <div class="space-y-6">
      ...
      @if (loading) {
        ...
        <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h2 class="mt-1 text-lg font-semibold text-slate-950">Produccion Tiempo Real</h2>
          <div class="mt-5 rounded-md border border-dashed border-slate-300 bg-slate-50 p-5">
            ...
            <p class="mt-2 font-mono text-sm text-slate-700">
              {{ dashboard.grafanaEmbedConfig?.dashboardUid || 'medussa-production-rt' }}
            </p>
            <p class="mt-4 text-sm text-slate-600">
              La version final consultara Data Warehouse y datamarts de produccion via Grafana. Esta HU no
              crea iframe real, token firmado, URL embebida, WebSockets ni conexion directa a equipos de planta.
            </p>
