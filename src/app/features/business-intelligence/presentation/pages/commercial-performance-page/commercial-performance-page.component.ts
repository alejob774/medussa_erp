        ...
        <section class="grid gap-6 2xl:grid-cols-[1.25fr_0.75fr]">
          ...
          <article class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <app-bi-grafana-demo-embed
              ...
              fallbackDashboardUid="medussa-commercial"
              title="Ventas y cumplimiento comercial"
              description="La version final consultara el datamart comercial via Grafana. Esta fase demo/local no crea token firmado, URL productiva, ETL ni conexion a backend."
            ></app-bi-grafana-demo-embed>
          </article>
        </section>
      }
