      ...
      @if (loading) {
        ...
        <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <app-bi-grafana-demo-embed
            ...
            fallbackDashboardUid="medussa-forecast"
            title="Demanda vs Forecast"
            description="La version final consultara el datamart de demanda y forecast via Grafana. Esta fase demo/local no crea token firmado, URL productiva, ETL ni conexion a backend."
          ></app-bi-grafana-demo-embed>
        </section>
      }
    </div>
