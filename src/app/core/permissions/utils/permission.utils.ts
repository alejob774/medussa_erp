...
> = {
  ...
  'orders.view': ['pedidos_view', 'ordenes_pedido_view', 'sales.view'],
  'orders.create': ['pedidos_create', 'ordenes_pedido_create', 'sales.view'],
  'orders.sync': ['pedidos_sync', 'inventarios_disponibilidad_view', 'inventory.view', 'sales.view'],
  'orders.send': ['pedidos_send', 'pedidos_consolidado_create', 'sales.view'],
  ...
  'mps.view': ['mps_view', 'production.view', 'inventory.view'],
  'mps.generate': ['mps_generate', 'production.view', 'inventory.view'],
  'mps.edit': ['mps_edit', 'production.view', 'inventory.view'],
  'mps.simulate': ['mps_simulate', 'production.view', 'inventory.view'],
  'mps.approve': ['mps_approve', 'production.view', 'inventory.view'],
  'tpm.view': ['tpm_view', 'production.view', 'equipments.view'],
  'tpm.create': ['tpm_create', 'production.view', 'equipments.view'],
  'tpm.edit': ['tpm_edit', 'production.view', 'equipments.view'],
  'tpm.close': ['tpm_close', 'production.view', 'equipments.view'],
  ...
  'deliveries.view': ['entregas_view', 'logistica_entregas_view', 'warehouse.view'],
  'deliveries.confirm': ['entregas_confirm', 'logistica_entregas_confirm', 'warehouse.view'],
  'deliveries.partial': ['entregas_partial', 'logistica_entregas_partial', 'warehouse.view'],
  'deliveries.trace': ['entregas_trace', 'logistica_entregas_trace', 'warehouse.view'],
  'bi.executive.view': ['bi_executive_view', 'dashboard.view'],
  'bi.profitability.view': ['bi_profitability_view', 'finance.view'],
  'bi.alerts.view': ['bi_alerts_view', 'dashboard.view'],
  'bi.commercial.view': ['bi_commercial_view', 'sales.view'],
  'bi.clients.view': ['bi_clients_view', 'clients.view'],
  'bi.forecast.view': ['bi_forecast_view', 'demand.analysis.view'],
  'bi.operations.production-rt.view': ['bi_operations_production_rt_view', 'production.view'],
  'bi.operations.oee.view': ['bi_operations_oee_view', 'production.view'],
  'bi.operations.quality.view': ['bi_operations_quality_view', 'quality.control.view'],
  'bi.supply.inventory.view': ['bi_supply_inventory_view', 'inventory.view'],
  'bi.supply.purchases.view': ['bi_supply_purchases_view', 'purchase.analysis.view'],
  'bi.supply.logistics.view': ['bi_supply_logistics_view', 'picking.packing.view'],
